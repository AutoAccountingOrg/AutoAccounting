...
interface CategoryDao {
    ...
    @Query("SELECT * FROM CategoryModel WHERE remoteBookId=:book AND type = :type ORDER BY id")
    suspend fun loadByBookAndType(book: String, type: String): List<CategoryModel>
