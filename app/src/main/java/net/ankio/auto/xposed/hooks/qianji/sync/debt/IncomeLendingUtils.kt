...
class IncomeLendingUtils :
    ...
    override suspend fun sync(billModel: BillInfoModel) = withContext(Dispatchers.IO) {
        ...
        AppRuntime.d("借入: ${billModel.money} ${billModel.accountNameFrom} -> ${billModel.accountNameTo}, isNewAssets=$isNewAssets")
