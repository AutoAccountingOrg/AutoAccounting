...
class PermissionHooker33(private val  manifest: HookerManifest, private val mClassLoader: ClassLoader)  {
    ...
    fun startHook() {
        try {
            ...
            manifest.logD("Error in PermissionHooker33: $e")
            manifest.logE(e)
        }
    }

    private fun hookGrantPermissions() {
        manifest.logD("Hooking grantPermissions() for Android 33+")
