...
class WebViewHooker(hooker: Hooker) : PartHooker(hooker) {
    ...
    override fun onInit(classLoader: ClassLoader, context: Context) {
        val webview = XposedHelpers.findClass("com.alipay.mywebview.sdk.WebView",classLoader)
        val callback = XposedHelpers.findClass("com.alipay.mywebview.sdk.ValueCallback",classLoader)
        /**
         ...
         */
        XposedHelpers.findAndHookMethod(webview,"evaluateJavascript",String::class.java,callback,object :XC_MethodHook(){
